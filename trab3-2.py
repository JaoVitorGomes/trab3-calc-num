...
funcao = ((1500 * (1 + ((sp.sin(x/2) + 1)**0.0001))**240) - 1500) / 750000 - ((sp.sin(x/2) + 1)**0.0001)
derivada = sp.diff(funcao, x)

[meses_necessarios, erro, n_iteracoes] = metodos.Newton(funcao, derivada, 0.05, 1e-6, 1000)
...
[tempo, erro, n_iteracoes] = metodos.Newton(funcao, derivada, 0.05, 1e-6, 1000)
